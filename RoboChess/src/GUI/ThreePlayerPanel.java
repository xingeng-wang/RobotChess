...
public class ThreePlayerPanel extends DisplayPanel {
	...
	public ThreePlayerPanel(int width, int height, ActionListener al) {
		...
		JLabel title = new JLabel("Three Player Set Up");
		...
		twoHumans.setActionCommand("threeHumans");
		twoHumans.addActionListener(al);
		...
		DisplayPanel mapSizeSubPanel = new DisplayPanel();
		mapSizeSubPanel.setLayout(new GridLayout(1, 3));
		JLabel mapsize = new JLabel("Map Size");
		mapsize.setFont(new Font("Arial", Font.BOLD, FONT_SIZE));
		mapsize.setForeground(Color.BLACK);
		mapsize.setAlignmentX(Component.CENTER_ALIGNMENT);
		mapSizeSubPanel.add(mapsize);
		
		JRadioButton fiveSpaces = new JRadioButton("5 Spaces");
		fiveSpaces.setActionCommand("fiveSpaces");
		fiveSpaces.setSelected(true);
		fiveSpaces.addActionListener(al);
		mapSizeSubPanel.add(fiveSpaces);
		
		JRadioButton sevenSpaces = new JRadioButton("7 Spaces");
		sevenSpaces.setActionCommand("sevenSpaces");
		sevenSpaces.addActionListener(al);
		mapSizeSubPanel.add(sevenSpaces);
		
		ButtonGroup group1 = new ButtonGroup();
		group1.add(fiveSpaces);
		group1.add(sevenSpaces);
		...
		create.setActionCommand("startthree");
